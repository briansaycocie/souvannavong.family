...
### Changes
- feat: add enhanced analytics tracking with 8 custom events

## [1.7.0] - 2026-02-11

### Changes
- feat: add License & Attribution page with citation guidelines and MIT license text
...
### Changes
- feat: add LLM support with llms.txt file

## [1.4.1] - 2026-02-11

### Changes
- fix: update reference from 'the user' to 'family historian'

## [1.4.0] - 2026-02-11

### Changes
- feat: add IndexNoww support

## [1.3.0] - 2026-02-11

### Changes
- feat: optimize title tags for better SEO
...
[1.3.0]: https://github.com/\briansaycocie/souvannavong.family/releases/tag/v1.3.0

[1.4.0]: https://github.com/\briansaycocie/souvannavong.family/releases/tag/v1.4.0
...
[1.7.0]: https://github.com/\briansaycocie/souvannavong.family/releases/tag/v1.7.0

[1.8.0]: https://github.com/\briansaycocie/souvannavong.family/releases/tag/v1.8.0
